...
<!--            <a href="articles.php">Liste des articles</a>  |-->
            ...
            <h2 id="block-header" style="text-align: left;">Articles achetés</h2><br>
            ...
            <div class="row">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        $result=mysqli_query($con, "select nomArticle, detailArticle, anneeFabrication, couleurArticle, poidsArticle, prixUnitArticle, fournisseurArticle, nomUser  from tAchat inner join tarticle on tArticle.id_article=tAchat.id_article inner join tuser on tuser.id_user=tachat.id_user");

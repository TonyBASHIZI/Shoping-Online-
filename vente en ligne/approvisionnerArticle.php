...
<html>
    ...
    <!-------------------------------Main content------------------------>
        <div class="container" id="container">
            <h2 id="block-header" style="text-align: left;">Approvisionner l'article</h2> <br>
            <div class="row">
                ...
                while ($row=mysqli_fetch_array($result))
                {
                    ?>
                        ...
                        <div class="col-md-3" id="" style="height:;">
...
<!--                        <a href="articleDel.php?idArticle=--><?php //echo $row["id_article"]; ?><!--" class="btn btn-danger" style="clear: both; margin: 20px; width: 140px">Supprimer</a>-->
                        <div class="col-md-3">
                            <form action="insertApprov.php" method="post">
                                Quantité
                                <input type="number" name="qteApprov" class="form-control" value="0">
                                <input type="hidden" name="id_article" value="<?php echo $row["id_article"];?>">
                                <input type="hidden" name="qteStock" value="<?php echo $row["quantiteStock"];?>">
                                <input type="submit" name="approv" class="btn btn-info" value="Valider" style="clear: both; margin: 20px; width: 140px">
<!--                                <a href="" type="submit" name="approv" class="btn btn-info" style="clear: both; margin: 20px; width: 140px">Valider</a>-->
                            </form>
